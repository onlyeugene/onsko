...
<template>
  <div
    class="w-full max-w-[1440px] sticky top-0 mx-auto rounded-full bg-primary backdrop-blur-sm shadow-md z-80"
  >
    <!-- Main Navigation Bar -->
    <div class="flex items-center justify-between py-1 px-6 border-gray-200">
      ...
      <div class="flex items-center gap-1 text-white">
        ...
        <h1 class="text-[32px] text-white font-poppins font-semibold">onsko</h1>
      </div>
      ...
      <div class="flex items-center gap-6 text-sm text-white space-x-4">
        ...
        <div class="flex items-center gap-1 relative cursor-pointer">
          <input
            type="text"
            placeholder="Search"
            class="outline-none bg-transparent rounded-full hover:bg-[#ae3a0068] hover:border w-full px-3 py-2 placeholder:text-white transition-colors duration-200 cursor-pointer"
          />
